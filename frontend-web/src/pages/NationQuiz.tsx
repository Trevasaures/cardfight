  ...
  return (
    <>
      ...
      >
        ...
        {!complete ? (
          <div className="mt-4 grid items-start gap-4 xl:grid-cols-[minmax(0,1.5fr)_minmax(0,0.85fr)]">
            <section className="min-w-0 rounded-2xl border border-cyan-300/20 bg-cyan-300/5 p-4">
              ...
              <div className="mt-4 grid gap-2">
                {currentQuestion.options.map((option, index) => (
                  <button
                    ...
                    className="group rounded-xl border border-white/10 bg-black/20 p-3 text-left transition hover:border-cyan-300/30 hover:bg-cyan-300/10 focus-visible:outline-2 focus-visible:outline-cyan-300"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-sm font-bold text-slate-100 transition group-hover:text-cyan-100">
                          {option.label}
                        </p>
                        {option.hint ? (
                      ...
                      <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-white/[0.04] text-slate-400 transition group-hover:border-cyan-300/30 group-hover:text-cyan-100">
          ...
          <div className="mt-4 grid items-start gap-4 xl:grid-cols-[minmax(0,1.5fr)_minmax(0,0.85fr)]">
            <section className="min-w-0 rounded-2xl border border-cyan-300/25 bg-cyan-300/10 p-4 sm:p-5">
              ...
              <h4 className="mt-4 text-3xl font-black tracking-tight text-slate-50 sm:text-4xl">
              ...
              <button
                type="button"
                onClick={resetQuiz}
                className="workspace-button mt-4 border border-cyan-300/20 bg-cyan-300/10 text-cyan-100 hover:bg-cyan-300/15"
              >
                <RefreshCcw className="h-4 w-4" />
                Retake quiz
              </button>
